...
void base_test_dir() {
	...
	ifstream ifs("C:\\Users\\Samvel\\source\\repos\\lab_6\\lab_6\\preset2.txt");
...
void algo_test_dijkstra_dir() {
	directed_graph<int> d_gr;
	ifstream ifs("C:\\Users\\Samvel\\source\\repos\\lab_6\\lab_6\\preset1.txt");
	d_gr.read_fstream(ifs, true);
...
void algo_test_connectivity() {
	undirected_graph<int> d_gr;
	ifstream ifs("C:\\Users\\Samvel\\source\\repos\\lab_6\\lab_6\\preset_unconnective.txt");
	d_gr.read_fstream(ifs, true);
